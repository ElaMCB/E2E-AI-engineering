        ...
        if len(historical_data) >= 2:
            ...
            if prev_count == 0 and curr_count > 0:
                changes.append(Change(
                    ...
                    description=f"New activity after quiet week: {prev_count} → {curr_count} updates",
                    magnitude=6.0,
...
class IntelligentAnalyzer:
    ...
    def analyze_weekly_data(self) -> Dict:
        ...
        if failed_runs:
            ...
            return {
                "error": "Analysis agent failure",
                "failed_agents": failed_agents,
                "details": {run.agent_name: run.error for run in failed_runs},
            }
