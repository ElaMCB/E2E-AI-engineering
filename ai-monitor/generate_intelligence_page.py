...
"""
    ...
    <script>
        ...
        function createAgentMessage(text, isUser) {
            ...
            icon.style.color = isUser ? 'var(--success)' : 'var(--primary)';
        ...
        function sendMessage() {
            ...
            messagesDiv.appendChild(createAgentMessage(question, true));
            ...
            // Add agent response
            setTimeout(() => {
                messagesDiv.appendChild(createAgentMessage(response, false));
