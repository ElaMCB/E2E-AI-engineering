...
"""
    ...
    <script>
        ...
        function appendMessage(iconClass, iconColor, text, alignRight) {
        ...
        function sendMessage() {
            ...
            // Add user message
            appendMessage('fas fa-user', 'var(--success)', question, true);
            ...
            // Add agent response
            setTimeout(() => {
                appendMessage('fas fa-robot', 'var(--primary)', response, false);
            }, 500);
